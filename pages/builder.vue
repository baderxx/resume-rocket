...
const experienceSection = computed<Section>(() => ({
    ...
    itemTitleTemplate: [{ fieldName: 'jobTitle' }, { text: 'at' }, { fieldName: 'employer' }]
}))
    ...
    <v-container>
        <v-row>
            <v-col cols="6">
                ...
                <builder-section v-for="(section, idx) in builderSections" :section-title="section.title"
                    :item-title-template="section.itemTitleTemplate" :section-subtitle="section.subtitle"
                    :form-template="section.formTemplate" :add-action-text="section.addActionText"
